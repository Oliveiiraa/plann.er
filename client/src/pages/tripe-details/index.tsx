import { Calendar, CircleCheck, CircleDashed, Link2, MapPin, Plus, PlusIcon, Settings2, UserCog } from "lucide-react";
        ...
        <div className="w-80 space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex item-center justify-between gap-4">
                <div className="space-y-1.5">
                  <span className="block font-medium text-zinc-100">Pessoa Teste</span>
                  <span className="block font-sm text-zinc-400 truncate">teste@teste.com</span>
                </div>
